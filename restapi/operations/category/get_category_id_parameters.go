...
func NewGetCategoryIDParams() GetCategoryIDParams {
	...
	return GetCategoryIDParams{}
}

// GetCategoryIDParams contains all the bound params for the get category ID operation
...
func (o *GetCategoryIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
