...
func NewPutCategoryIDParams() PutCategoryIDParams {
	...
	return PutCategoryIDParams{}
}

// PutCategoryIDParams contains all the bound params for the put category ID operation
...
func (o *PutCategoryIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
