...
func NewDeleteCategoryIDParams() DeleteCategoryIDParams {
	...
	return DeleteCategoryIDParams{}
}

// DeleteCategoryIDParams contains all the bound params for the delete category ID operation
...
func (o *DeleteCategoryIDParams) bindID(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
